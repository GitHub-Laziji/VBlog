            ...
            <el-row>
                <el-col :span="9" style="padding: 0px 10px 20px 0px">
                    ...
                    <div style="padding: 10px">
                        ...
                        <font style="font-size: 20px;font-style: normal;font-weight: 300;line-height: 24px;color: #666;">{{githubUsername}}
                            <br>
                        </font>
                        <font style="font-size: 14px;line-height: 40px;color:#606266;" v-if="location">
